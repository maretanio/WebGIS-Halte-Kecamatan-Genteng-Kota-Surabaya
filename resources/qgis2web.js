...
map.getView().fit([12548230.975813, -812647.193506, 12554064.078159, -808869.756573], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Halte Kecamatan Genteng Kota Surabaya</h2>';
        return titleElement;
    })(),
